...
let g:kyotonight#blue01       = get(g:, "kyotonight#blue1", ["#7dcfff", "12"])
let g:kyotonight#blue00       = get(g:, "kyotonight#blue0", ["#7aa2f7", "4"])
...
let g:kyotonight#black = "#000000",
    let g:kyotonight#red = "#EF1D55",
    let g:kyotonight#magenta = "#A06469",
    let g:kyotonight#orange = "#FF5813",
    let g:kyotonight#green = "#819C3B",
    let g:kyotonight#yellow = "#FF9500",
    let g:kyotonight#aqua = "#7EB2B1",
    let g:kyotonight#blue = "#4C96A8",
    let g:kyotonight#purple = "#98676A",
    let g:kyotonight#blue1 = "#3B5998",
    let g:kyotonight#blue2 = "#8B9DC3",
    let g:kyotonight#blue3 = "#DFE3EE",
    let g:kyotonight#purple1 = "#8D0A9D",
    let g:kyotonight#purple2 = "#9E36D2",
    purple3 = "#CA69E3",
    let g:kyotonight#red1 = "#A70000",
    let g:kyotonight#red2 = "#FF0000",
    let g:kyotonight#red3 = "#FFBABA",
    let g:kyotonight#yellow1 = "#A57D00",
    let g:kyotonight#yellow2 = "#F9C64E",
    let g:kyotonight#yellow3 = "#F9D889",
    let g:kyotonight#green1 = "#326300",
    let g:kyotonight#green2 = "#37B810",
    let g:kyotonight#green3 = "#D2F4C6",
    let g:kyotonight#orange1 = "#F4931F",
    let g:kyotonight#orange2 = "#F6A84B",
    let g:kyotonight#orange3 = "#FCE9D2",
    let g:kyotonight#gray1 = "#353535",
    let g:kyotonight#gray2 = "#6D6D6D",
    let g:kyotonight#gray3 = "#DDDDDD",
