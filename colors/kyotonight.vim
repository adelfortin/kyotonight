...
let g:kyotonight#orange01      = get(g:, "kyotonight#orange1", ["#ff9e64", "3"])
...
let g:kyotonight#black       = get(g:, "kyotonight#black", ["#000000", "16"])
    let g:kyotonight#red     = get(g:, "kyotonight#red", ["#EF1D55", "17"])
    let g:kyotonight#magenta     = get(g:, "kyotonight#magenta", ["#A06469", "18"])
    let g:kyotonight#orange     = get(g:, "kyotonight#orange", ["#FF5813", "19"])
    let g:kyotonight#green     = get(g:, "kyotonight#green", ["#819C3B", "20"])
    let g:kyotonight#yellow     = get(g:, "kyotonight#yellow", ["#FF9500", "21"])
    let g:kyotonight#aqua     = get(g:, "kyotonight#aqua", ["#7EB2B1", "22"])
    let g:kyotonight#blue     = get(g:, "kyotonight#blue", ["#4C96A8", "23"])
    let g:kyotonight#purple     = get(g:, "kyotonight#purple", ["#98676A", "24"])
    let g:kyotonight#blue1     = get(g:, "kyotonight#blue1", ["#3B5998", "25"])
    let g:kyotonight#blue2     = get(g:, "kyotonight#blue2", ["#8B9DC3", "26"])
    let g:kyotonight#blue3     = get(g:, "kyotonight#blue3", ["#DFE3EE", "27"])
    let g:kyotonight#purple1     = get(g:, "kyotonight#purple1", ["#8D0A9D", "27"])
    let g:kyotonight#purple2     = get(g:, "kyotonight#purple2", ["#9E36D2", "28"])
    let g:kyotonight#purple3     = get(g:, "kyotonight#purple3", ["#CA69E3", "29"])
    let g:kyotonight#red1     = get(g:, "kyotonight#red1", ["#A70000", "30"])
    let g:kyotonight#red2     = get(g:, "kyotonight#red2", ["#FF0000", "31"])
    let g:kyotonight#red3     = get(g:, "kyotonight#red3", ["#FFBABA", "32"])
    let g:kyotonight#yellow1     = get(g:, "kyotonight#yellow1", ["#A57D00", "33"])
    let g:kyotonight#yellow2     = get(g:, "kyotonight#yellow2", ["#F9C64E", "34"])
    let g:kyotonight#yellow3     = get(g:, "kyotonight#yellow3", ["#F9D889", "35"])
    let g:kyotonight#green1     = get(g:, "kyotonight#green1", ["#326300", "36"])
    let g:kyotonight#green2     = get(g:, "kyotonight#green2", ["#37B810", "37"])
    let g:kyotonight#green3     = get(g:, "kyotonight#green3", ["#D2F4C6", "38"])
    let g:kyotonight#orange1     = get(g:, "kyotonight#orange1", ["#F4931F", "39"])
    let g:kyotonight#orange2     = get(g:, "kyotonight#orange2", ["#F6A84B", "40"])
    let g:kyotonight#orange3     = get(g:, "kyotonight#orange3", ["#FCE9D2", "41"])
    let g:kyotonight#gray1     = get(g:, "kyotonight#gray1", ["#353535", "42"])
    let g:kyotonight#gray2     = get(g:, "kyotonight#gray2", ["#6D6D6D", "43"])
    let g:kyotonight#gray3     = get(g:, "kyotonight#gray3", ["#DDDDDD", "44"])
