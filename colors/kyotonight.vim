...
let g:kyotonight#blue01       = get(g:, "kyotonight#blue01", ["#7dcfff", "12"])
let g:kyotonight#blue00       = get(g:, "kyotonight#blue00", ["#7aa2f7", "4"])
let g:kyotonight#cyan0       = get(g:, "kyotonight#cyan0", ["#2ac3de", "6"])
let g:kyotonight#red         = get(g:, "kyotonight#red", ["#f7768e", "1"])
let g:kyotonight#orange1      = get(g:, "kyotonight#orange1", ["#ff9e64", "3"])
...
let g:kyotonight#black       = get(g:, "kyotonight#black", ["#000000", "NONE"])
    let g:kyotonight#red     = get(g:, "kyotonight#red", ["#EF1D55", "NONE"])
    let g:kyotonight#magenta     = get(g:, "kyotonight#magenta", ["#A06469", "NONE"])
    let g:kyotonight#orange     = get(g:, "kyotonight#orange", ["#FF5813", "NONE"])
    let g:kyotonight#green     = get(g:, "kyotonight#green", ["#819C3B", "NONE"])
    let g:kyotonight#yellow     = get(g:, "kyotonight#yellow", ["#FF9500", "NONE"])
    let g:kyotonight#aqua     = get(g:, "kyotonight#aqua", ["#7EB2B1", "NONE"])
    let g:kyotonight#blue     = get(g:, "kyotonight#blue", ["#4C96A8", "NONE"])
    let g:kyotonight#purple     = get(g:, "kyotonight#purple", ["#98676A", "NONE"])
    let g:kyotonight#blue1     = get(g:, "kyotonight#blue1", ["#3B5998", "NONE"])
    let g:kyotonight#blue2     = get(g:, "kyotonight#blue2", ["#8B9DC3", "NONE"])
    let g:kyotonight#blue3     = get(g:, "kyotonight#blue3", ["#DFE3EE", "NONE"])
    let g:kyotonight#purple1     = get(g:, "kyotonight#purple1", ["#8D0A9D", "NONE"])
    let g:kyotonight#purple2     = get(g:, "kyotonight#purple2", ["#9E36D2", "NONE"])
    let g:kyotonight#purple3     = get(g:, "kyotonight#purple3", ["#CA69E3", "NONE"])
    let g:kyotonight#red1     = get(g:, "kyotonight#red1", ["#A70000", "NONE"])
    let g:kyotonight#red2     = get(g:, "kyotonight#red2", ["#FF0000", "NONE"])
    let g:kyotonight#red3     = get(g:, "kyotonight#red3", ["#FFBABA", "NONE"])
    let g:kyotonight#yellow1     = get(g:, "kyotonight#yellow1", ["#A57D00", "NONE"])
    let g:kyotonight#yellow2     = get(g:, "kyotonight#yellow2", ["#F9C64E", "NONE"])
    let g:kyotonight#yellow3     = get(g:, "kyotonight#yellow3", ["#F9D889", "NONE"])
    let g:kyotonight#green1     = get(g:, "kyotonight#green1", ["#326300", "NONE"])
    let g:kyotonight#green2     = get(g:, "kyotonight#green2", ["#37B810", "NONE"])
    let g:kyotonight#green3     = get(g:, "kyotonight#green3", ["#D2F4C6", "NONE"])
    let g:kyotonight#orange1     = get(g:, "kyotonight#orange1", ["#F4931F", "NONE"])
    let g:kyotonight#orange2     = get(g:, "kyotonight#orange2", ["#F6A84B", "NONE"])
    let g:kyotonight#orange3     = get(g:, "kyotonight#orange3", ["#FCE9D2", "NONE"])
    let g:kyotonight#gray1     = get(g:, "kyotonight#gray1", ["#353535", "NONE"])
    let g:kyotonight#gray2     = get(g:, "kyotonight#gray2", ["#6D6D6D", "NONE"])
    let g:kyotonight#gray3     = get(g:, "kyotonight#gray3", ["#DDDDDD", "NONE"])
